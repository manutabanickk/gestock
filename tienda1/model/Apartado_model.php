...
class ApartadoModel extends Conexion
{
    ...
    public function Autocomplete_Producto($search)
    {
        try {
            ...
            echo json_encode($sugg_json, JSON_UNESCAPED_SLASHES);
        } catch (Exception $e) {
            echo "Error al cargar el listado";
        }
    }
    ...
    public function Insertar_Apartado($fecha_limite_retiro, $sumas, $iva, $exento, $retenido, $descuento, $total, $abonado_apartado, $restante_pagar, $sonletras, $idcliente, $idusuario)
    {
        $dbconec = Conexion::Conectar();
        try {
            $query = "CALL sp_insert_apartado(:fecha_limite_retiro, :sumas, :iva, :exento, :retenido, :descuento, :total, :abonado_apartado, :restante_pagar, :sonletras, :idcliente, :idusuario)";
    ...
    public function Insertar_Venta($idapartado, $tipo_pago, $tipo_comprobante, $pago_efectivo, $pago_tarjeta, $numero_tarjeta, $tarjeta_habiente, $cambio, $idcliente, $idusuario)
    {
        $dbconec = Conexion::Conectar();
        try {
            $query = "CALL sp_insert_venta_apartado(:idapartado, :tipo_pago, :tipo_comprobante, :pago_efectivo, :pago_tarjeta, :numero_tarjeta, :tarjeta_habiente, :cambio, :idcliente, :idusuario)";
