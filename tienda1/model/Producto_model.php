...
class ProductoModel extends Conexion
{
    ...
    public function Autocomplete_Producto($search)
    {
        ...
        try
        {
            ...
            $sugg_json = array();    // this is for displaying json data as an autosearch suggestion
            $json_row = array();     // this is for storing MySQL results in json string
    ...
    public function Insertar_Producto(
        $codigo_barra, $nombre_producto, $precio_compra, $precio_venta,
    ...
    public function Editar_Producto(
        $idproducto, $codigo_barra, $nombre_producto, $precio_compra, $precio_venta,
        $precio_venta_mayoreo, $precio_venta_3, $stock_min, $idcategoria, $idmarca,
        $idpresentacion, $estado, $exento, $inventariable, $perecedero
    ) {
        $dbconec = Conexion::Conectar();
        try
        {
            $query = "CALL sp_update_producto(
                :idproducto, :codigo_barra, :nombre_producto, :precio_compra,
                :precio_venta, :precio_venta_mayoreo, :precio_venta_3, :stock_min,
