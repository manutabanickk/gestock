...
if (!defined('TUSFACTURAS_API_VERSION')) {
    define('TUSFACTURAS_API_VERSION', 2);
}
if (!defined('TUSFACTURAS_PATH')) {
    define('TUSFACTURAS_PATH', "https://www.tusfacturas.app/app/api/v".TUSFACTURAS_API_VERSION."/");
}
